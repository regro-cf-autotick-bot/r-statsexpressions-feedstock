About r-statsexpressions-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-statsexpressions-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-statsexpressions-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-statsexpressions
# for installing globally
pixi global install r-statsexpressions
```
...
It is possible to list all of the versions of `r-statsexpressions` available on your platform:
...
```
pixi search r-statsexpressions --channel conda-forge
```
